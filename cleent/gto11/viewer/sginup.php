<?php
    $output = "";
    if(isset($_POST['btnsginup'])){
        include_once('../controller/dbcontroller.php');
             include_once('../model/signup.php');
        $dbcontroller = new dbcontroller();
        $output = $dbcontroller->signup('',$_POST['Fullname'],$_POST['Email'],$_POST['Password']);
        if($output){
...
<form action="reg1.php" style="max-width:500px;margin:auto">
  ...
  <button name="btnsginup" type="submit" class="btn btn-dark z-depth-2">Register</button>
</form>
