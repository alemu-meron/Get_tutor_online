     ...
     <header role="banner">       
       ...
       <a class="nav-link p-0" href="#">
          <img src="..\view\img\logo.PNG" class="rounded-circle z-depth-0"
               alt="avatar image" height="80" width="80"> </a> 
...
<!--                     <ul class="navbar-nav absolute-right text-black dacolor">
              <li>
                <a text-black href="login.php">Login</a> / <a text-black href="registration.php">Register</a>
              </li>
            --></ul> <ul class="navbar-nav absolute-right">
      ...
      <section class="site-hero site-sm-hero overlay" data-stellar-background-ratio="0.5" style="background-image: url(images/land1.jpg);">
      <div class="container">
    ...
    <section class="site-section">
      <div class="container">
        ...
        <div class="col-md-6 text-center">
              <input type="button" onclick="location.href='reg1.php';" value="Register as a Client" />
                   </div>
        <div class="col-md-6"> <input type="button" onclick="location.href='../view/tutorSignUp.php';" value="Be a Tutor now" />
            </div>
      </div>
              </div>
          </div>
