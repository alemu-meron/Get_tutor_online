...
<body>
    ...
    <div class="body" style="margin-left:20px; margin-right: 20px">
        
      <!-- Jumbotron -->
<div class="img" style="background-image: url(./img/ab.png);">
  <div class="text-white text-center  py-5 px-4">
    <div class="py-5">
      ...
      <h1>About Us</h1>
      <h4 class="mb-4 pb-2 px-md-5 mx-md-5">They offer a brief summary of their history, then allow visitors to click through various company events over the past 62 years.
          The best part of the design, though, is the inclusion of photos with each piece of information.
          Although many companies prominently display the year the company was founded, words just can’t convey the same feeling as an authentic photo of a 1953 diner.</h4>
    </div>
  </div>
</div>
<!-- Jumbotron -->
    ...
    <div class="d-flex justify-content-center mt-5 mb-5">
        <div class="jumbotron text-center" style="margin-right:20px;">

  <!-- Title -->
  <h4 class="card-title h4"><strong>My adventure</strong></h4>
